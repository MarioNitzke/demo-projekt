...
import type { Booking, CreateBookingRequest, BookingsPagedResponse, AvailabilityResponse } from './types';

async function payBooking(id: string): Promise<{ sessionId: string; url: string }> {
