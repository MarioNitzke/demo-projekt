...
using PhysioBook.Features.Webhooks.Stripe;
...
public static class EndpointRegistration
{
    public static void MapEndpoints(this WebApplication app)
    {
        ...
        var webhooksGroup = apiGroup.MapGroup("/webhooks")
            .WithTags("Webhooks");
    ...
    private static RouteGroupBuilder MapBookingEndpoints(this RouteGroupBuilder group)
    {
        ...
        group.MapCreateCheckoutSessionEndpoint();
        group.MapCancelBookingEndpoint();

        return group;
    }

    private static RouteGroupBuilder MapWebhookEndpoints(this RouteGroupBuilder group)
    {
        group.MapStripeWebhookEndpoint();
